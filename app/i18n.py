...
STRINGS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "cap.soaked": "Heavy rain",
        "cap.wet": "Rain",
        "cap.damp": "Rain risk",
        "cap.rain_detail": "{note}: a rain score of {value} caps the index at {cap}",
        # Warning kinds
    ...
    "de": {
        ...
        "cap.soaked": "Starkregen",
        "cap.wet": "Regen",
        "cap.damp": "Regenrisiko",
        "cap.rain_detail": "{note}: Regenwert {value} begrenzt den Index auf {cap}",
